...
import {postSoli} from "../../services/auth.services"
...
export const solicita_donacion = () => {
  ...
  const handleClick = async (e) => {
    ...
    if (titulo.trim() === '' || nombre.trim() === '' || email.trim() === '' || direccion.trim() === '' || tel.trim() === ''
      | motivo.trim() === '' || adicional.trim() === '' || !isChecked) {
      // Mostrar una alerta 
      ...
      navigate('/Solicitudes_donaciones');

      const formDataString = {
        title_Soli: titulo,
        Nombre_Soli: nombre,
        Email_Soli: email,
        telefono_Soli: direccion,
        direccion_Soli: tel,
        motivo_Soli: motivo,
        informacion_Soli: adicional,
        terminos_Soli: isChecked,
          ...
          <div className="w-full flex flex-col items-center justify-center m-5 max-w-[1350px] sm:w-[80%] md:w-[70%] lg:w-[80%] xl:w-[80%] h-auto bg-[#EAD7BB] rounded-[25px] overflow-hidden border-8 border-[#BCA37F]">
            ...
            <div className="m-5 flex flex-col items-center justify-center">
              ...
              <div className="flex flex-row items-center justify-center">
                ...
                <textarea
                  className="lg:w-[457px] w-[90%]  h-full bg-[#fff2d8] rounded-[15px] p-2 outline-none resize-none"
...
export default solicita_donacion;