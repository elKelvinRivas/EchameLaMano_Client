...
export const Info_donaciones = () => {

  const { titulo, nombre, tel, email, tipo, direccion, cantidad, adicional } = useParams();
          ...
          <div className="w-full flex flex-col items-center justify-center m-5 max-w-[1350px] sm:w-[80%] md:w-[70%] lg:w-[80%] xl:w-[80%] h-auto bg-[#EAD7BB] rounded-[25px] overflow-hidden border-8 border-[#BCA37F]">
            ...
            <div className="m-5 flex flex-col items-center justify-center">
              ...
              <div className="flex flex-row items-center justify-center">
                ...
                <div className="lg:w-[457px] w-[90%]  h-[58px] bg-[#fff2d8] rounded-[15px] p-2 outline-none resize-none">
                  {titulo}
                </div>
              </div>
            </div>
...
export default Info_donaciones;
